                ...
                for (int i = 3; i <= worksheet.Dimension.Rows; i++)
                {
                    try
                    {
                        ...
                        DatabaseModel databaseModel = new DatabaseModel
                        {
                            ...
                            DMAABitmeTarix = dmaaBitmeTarixi is null ? (DateTime?)null : Convert.ToDateTime(dmaaBitmeTarixi),
                            DMAAQeydiyyatTarixi = dmaaQeydiyyatTarixi is null ? (DateTime?)null : Convert.ToDateTime(dmaaQeydiyyatTarixi),
