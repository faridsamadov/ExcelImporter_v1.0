...
namespace Excel.Improter.Migrations
{
    ...
    [Migration("20210405082513_init_ImpirtImprove")]
    partial class init_ImpirtImprove
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Excel.Improter.Models.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Excel.Improter.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Excel.Improter.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Excel.Improter.Models.AppUser", null)
                        .WithMany()
